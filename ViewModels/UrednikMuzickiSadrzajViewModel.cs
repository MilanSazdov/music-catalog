...
namespace MusicCatalog.ViewModels
{
 ...
 {
 MessageBox.Show("Ve? ste ostavili recenziju. Možete je izmeniti.", "Informacija", MessageBoxButton.OK, MessageBoxImage.Information);
 return;
 }
 ...
 {
 MessageBox.Show("Nemate postoje?u recenziju za ovo delo.", "Informacija", MessageBoxButton.OK, MessageBoxImage.Information);
 return;
 }
 ...
 {
 MessageBox.Show("Ve? postoji zahtev (NA_CEKANJU ili ODBIJEN) za izmenu/brisanje ove recenzije.", "Obaveštenje", MessageBoxButton.OK, MessageBoxImage.Information);
 return;
 }
